import mysql.connector as madhuri   #install mysql connector "pip install mysql-connector"
from random import *
import datetime
...
try:
    ...
    global conn
    user_id=""
    conn=madhuri.connect(host="localhost",user="root",passwd="",database="rail_inq")
    cursor=conn.cursor()
    if user_id=="":
       log_sign()
    if user_id!="":
